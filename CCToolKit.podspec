...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Harry_L"
  # s.authors            = { "Harry_L" => "15645969688@163.com" }
  # s.social_media_url   = "http://twitter.com/Harry_L"
  ...
  s.source_files  = "CCToolKit", "CCToolKit/CCAppInfoManager.{h,m}"
