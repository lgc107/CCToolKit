...
//! Project version number for CCToolKit.
FOUNDATION_EXPORT double CCToolKitVersionNumber;

//! Project version string for CCToolKit.
FOUNDATION_EXPORT const unsigned char CCToolKitVersionString[];
