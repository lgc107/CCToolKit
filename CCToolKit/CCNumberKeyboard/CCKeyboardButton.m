...
@implementation CCKeyboardButton

+ (instancetype)keyboardButtonWithStyle:(CCNumberKeyboardButtonStyle)style
{
    CCKeyboardButton *button = [self buttonWithType:UIButtonTypeCustom];
    button.style = style;
...
- (void)setStyle:(CCNumberKeyboardButtonStyle)style
{
    if (style != _style) {
        _style = style;
...
- (void)_buttonStyleDidChange
{
    ...
    const CCNumberKeyboardButtonStyle style = self.style;
    
    UIColor *fillColor = nil;
    UIColor *highlightedFillColor = nil;
    if (style == CCNumberKeyboardButtonStyleWhite) {
        fillColor = [UIColor colorWithRed:0.96f green:0.96f blue:0.96f alpha:1.0];
        highlightedFillColor = [UIColor colorWithRed:0.70f green:0.70f blue:0.70f alpha:1];
    } else if (style == CCNumberKeyboardButtonStyleGray) {
        if (interfaceIdiom == UIUserInterfaceIdiomPad) {
            fillColor =  [UIColor colorWithRed:0.674f green:0.7f blue:0.744f alpha:1];
        } else {
            fillColor = [UIColor colorWithRed:0.87f green:0.87f blue:0.87f alpha:1];
        }
        highlightedFillColor = [UIColor whiteColor];
    } else if (style == CCNumberKeyboardButtonStyleDone) {
    ...
    if (style == CCNumberKeyboardButtonStyleDone) {
